...
const Hero = () => {
    const myThings = ['User Interfaces', 'Websites', 'Mobile Apps', "Web Apps", "APIs", "Cool Stuff"];
    ...
    let updateIcon = (index) => {
        switch(index !== undefined) {
            ...
            case index === 2:
                return <PhonePortrait className="inline" color="#F9D423" fontSize=".8em"/>;
            case index === 3:
                return <IosDesktop className="inline" color="#F9D423" fontSize=".8em"/>;
            case index === 4:
                return <IosCloud className="inline" color="#F9D423" fontSize=".8em"/>;
            case index === 5:
                return <MdPlanet className="inline" color="#F9D423" fontSize=".8em"/>;
            default:
                return <IosGameControllerA className="inline" color="#F9D423" fontSize=".8em"/>
        }
    }
    return (
        <header id="hero" className="hero-wrapper flex jutify-center">
            <section className="hero-message text-center sm:text-left z-10">
                ...
                <h3 className="sm:text-3xl md:text-4xl lg:text-5xl flex items-center justify-start flex-col sm:flex-row whitespace-no-wrap"> 
                    and I make 
                    <span id="thing" className="slideIn flex items-start justify-center pl-3">
                ...
                <div className="pt-2 flex items-center justify-center sm:justify-start">
                    <a className="sm:pr-2 md: pr-3" href="https://www.linkedin.com/in/jessie-wooten-80770a44" target="_blank" rel="noopener noreferrer">
                        <LogoLinkedin color="#fcfcfc" fontSize="2em" className="yellow-fill-hover"/>
                    </a>
                    <a className="sm:pr-2 md: pr-3" href="https://github.com/JessieWooten" target="_blank" rel="noopener noreferrer">
                        <LogoGithub color="#fcfcfc" fontSize="2em" className="yellow-fill-hover"/>
                    </a>
                    <a className="sm:pr-2 md: pr-3" href="https://codepen.io/JessieWooten" target="_blank" rel="noopener noreferrer">
                        <LogoCodepen color="#fcfcfc" fontSize="2em" className="yellow-fill-hover"/>
                    </a>
                </div>
            </section>
        </header>
